...
- <ins>Future Additions:</ins>
  ...
  - Make it multiple-language friendly. 
...
-  Git Happens pushed itself on multiple fronts. During brainstorming and planning we evaluated how best to achieve ConnectAI’s goals: what users would (or wouldn’t) benefit from, which incentives to offer, how to reach target audiences, and what makes our product original. Technically, team members utilized Google’s Flutter framework and Dart for the first time. Through iterative review and refinement, and mentor guidance, Git Happens produced an AI networking‑simulator demo with a user‑friendly interface that highlights the most important features, all within the hackathon submission deadline.
